...
#                   "../../output/texts/grab_test_0", "../../output/texts/smash_test_0", 
...
#                    "../../input/images/grab_test_0/resize2", "../../input/images/smash_test_0/resize2", 
...
input_text_dir = ["../../output/texts/air_senjou_test_0", "../../output/texts/b_senjou_test_0",
                  "../../output/texts/grab_senjou_test_0", "../../output/texts/smash_senjou_test_0", 
...
input_image_dir = ["../../input/images/air_senjou_test_0/resize2", "../../input/images/b_senjou_test_0/resize2",
                   "../../input/images/grab_senjou_test_0/resize2", "../../input/images/smash_senjou_test_0/resize2", 
        ...
        with open(os.path.join(text_dir, text_file), 'r') as f:
            ...
            if class_name == "Notwaza" and class_counts["Notwaza"] >= 2000:
                ...
                if class_name not in class_counts:
                    ...
                    class_counts[class_name] += 1
                output_text_path = os.path.join(output_label_dir, class_name + "_senjou_test_" + str(class_counts[class_name]).zfill(4) + ".txt")
                with open(output_text_path, 'w') as f:
                    f.write(first_line)

                output_image_path = os.path.join(output_image_dir, class_name + "_senjou_test_" + str(class_counts[class_name]).zfill(4) + ".png")
                # 元画像を読み込む
                ...
                image_names_list.append(class_name + "_senjou_test_" + str(class_counts[class_name]).zfill(4) + ".png")
